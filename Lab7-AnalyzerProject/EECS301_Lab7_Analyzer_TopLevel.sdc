## Generated SDC file "EECS301_Lab7_Analyzer_TopLevel.sdc"
...
#**************************************************************
# Set JTAG Interface Constraints
#**************************************************************
...
set_input_delay -add_delay  -clock [get_clocks {lcd_clk}]  10.000 [get_ports {KEY[0]}]
